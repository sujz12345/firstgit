...
$jsd('/AlphaAnimation/src/test1.htmlx',13,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);});function start() { 
$jsd('/AlphaAnimation/src/test1.htmlx',14,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); var alphaAnimation = new $M.AlphaAnimation({fromAlpha:0, toAlpha:1, duration:15000}); 
$jsd('/AlphaAnimation/src/test1.htmlx',19,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); div.addAnimation(alphaAnimation); 
$jsd('/AlphaAnimation/src/test1.htmlx',20,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); div.startAnimation(); 
} 
