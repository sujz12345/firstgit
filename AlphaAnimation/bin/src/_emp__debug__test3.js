...
$jsd('/AlphaAnimation/src/test3.htmlx',13,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);});function start() { 
$jsd('/AlphaAnimation/src/test3.htmlx',14,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); var alphaAnimation = new $M.AlphaAnimation({fromAlpha:0, toAlpha:1, duration:3000, repeatCount:20, repeatMode:$M.Animation.RESTART, interpolater:$M.Animation.Linear}); 
$jsd('/AlphaAnimation/src/test3.htmlx',22,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); div.addAnimation(alphaAnimation); 
$jsd('/AlphaAnimation/src/test3.htmlx',23,this,((typeof(arguments)!="undefined"?arguments:null)),function(__text){return eval(__text);}); div.startAnimation(); 
} 
